  ...
  return (
    <div className="relative text-center  bg-[#FFEDD5] h-screen ">
      <div className="container">
        <motion.div className=" pb-20 overflow-hidden w-full max-w-[1024px]  ">
          <motion.h1
            className="relative uppercase mt-10 flex justify-center items-center text-[80px] md:text-[120px] lg:text-[150px] transform scale-x-125 scale-y-200 text-[#ec9706] font-bold text-center"
            initial={{ y: "150px" }}
            whileInView={{
              y: "0",
          ...
          <div className="absolute bottom-0 w-full justify-between text-sm hidden lg:flex  items-end px-6">
            {/* Left text animation */}
            <motion.p
      ...
      <motion.div className="absolute z-60 bottom-0 w-full flex justify-between items-end p-6">
        ...
        <motion.div
          className=" text-[#ec9706] grid grid-cols-[60px_1fr]  border-2 max-w-[200px] h-20 text-xs"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 2, duration: 0.5 }}
        >
